<html>
  <head>
    ...
    <link rel="stylesheet" href="asset/customer/css/web-speech.css">
  ...
  <body>
          ...
          <div class="container mt-3">
              ...
              <div class="float-right">
                <button id="start_button">
                  <img id="start_img" src="asset/customer/images/mic.gif" alt="Start"></button>
              </div>
              <div id="results">
      ...
      <script src="asset/customer/js/languages.js"></script>
      <script src="asset/customer/js/web-speech-api.js"></script>
  </body>
</html>
