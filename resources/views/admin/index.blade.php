...
<head>
    ...
    <link href="{{URL::asset('asset/admin/vendor/vector-map/jqvmap.min.css')}}" rel="stylesheet" media="all">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="{{URL::asset('asset/admin/images/icon/logo-white.png')}}" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="{{URL::asset('asset/admin/images/icon/avatar-big-01.jpg')}}" alt="John Doe" />
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="{{URL::asset('asset/admin/images/icon/logo-white.png')}}" alt="CoolAdmin" />
                                </a>
                            </div>
    ...
    <!-- Jquery JS-->
    <script src="{{URL::asset('asset/admin/vendor/jquery-3.2.1.min.js')}}"></script>
    <!-- Bootstrap JS-->
    <script src="{{URL::asset('asset/admin/vendor/bootstrap-4.1/popper.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/bootstrap-4.1/bootstrap.min.js')}}"></script>
    <!-- Vendor JS       -->
    <script src="{{URL::asset('asset/admin/vendor/slick/slick.min.js')}}">
    </script>
    <script src="{{URL::asset('asset/admin/vendor/wow/wow.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/animsition/animsition.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}">
    </script>
    <script src="{{URL::asset('asset/admin/vendor/counter-up/jquery.waypoints.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/counter-up/jquery.counterup.min.js')}}">
    </script>
    <script src="{{URL::asset('asset/admin/vendor/circle-progress/circle-progress.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/perfect-scrollbar/perfect-scrollbar.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/chartjs/Chart.bundle.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/select2/select2.min.js')}}">
    </script>
    <script src="{{URL::asset('asset/admin/vendor/vector-map/jquery.vmap.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/vector-map/jquery.vmap.min.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/vector-map/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{URL::asset('asset/admin/vendor/vector-map/jquery.vmap.world.js')}}"></script>

    <!-- Main JS-->
    <script src="{{URL::asset('asset/admin/js/main.js')}}"></script>
